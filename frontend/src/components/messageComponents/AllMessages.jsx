                        ...
                        <Fragment key={message._id}>
                            ...
                            >
                                ...
                                <div
                                    className={`${
                                        message?.sender?._id === adminId
                                            ? "bg-gradient-to-tr to-green-800 from-green-400 rounded-s-lg rounded-ee-2xl"
                                            : "bg-gradient-to-tr to-green-800 from-white rounded-e-lg rounded-es-2xl"

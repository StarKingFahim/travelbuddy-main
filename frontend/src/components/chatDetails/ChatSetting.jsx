	...
	return (
		<div className="flex flex-col p-2 gap-2 text-white relative h-full z-10 overflow-auto scroll-style">
			...
			<div
				...
				className="w-full h-8 border-green-500 border text-sm rounded-lg flex justify-between items-center p-2 font-normal gap-2 transition-all cursor-pointer text-white"
			>
				<h1>Clear Chat</h1>
				<CiCircleInfo
					fontSize={15}
			...
			{isConfirm && (
				<div className="px-2 w-full fixed bottom-1 right-0">
					<div
						className={`w-full h-12 border-green-500 ${

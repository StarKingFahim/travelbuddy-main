...
// Here we defining the application based on express.js
const app = express();

// Here we are setupping the cors options, so frontend allowed to make request
const corsOptions = {
...
// Defining the routes here for the application
app.use("/api/auth", authRouter);
app.use("/api/user", userRouter);
app.use("/api/chat", chatRouter);
app.use("/api/message", messageRouter);

// Support for the all invalid routes
app.all("*", (req, res) => {
